...
import { KEY_CONSTRUCTION_OPTIONS } from "../../../../../utils/consts";
...
export const ConstructionFilter = ({
  ...
  const setStorageOptions = () => {
    ...
    localStorage.setItem(KEY_CONSTRUCTION_OPTIONS, constructionOptions);
  };
  ...
  const clearValues = () => {
    setOptions([]);
    setValue(null);
    localStorage.removeItem(KEY_CONSTRUCTION_OPTIONS);
  };
